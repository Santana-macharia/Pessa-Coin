...
<div class="row">
  <div class="col-md-12 just-centered">
    <h1 class="bold-text">Buy and Sell PessaCoin Everywhere</h1>
    <h2 class="tagline"><b>Near you or around the globe.</b></h2>
  </div>
</div>
<div class="row">
  <div class="col-md-12 just-centered">
    <div>
      <p class="tagline lead">
        Trade PessaCoins person-to-person in an <b>easy</b>, <b>fast</b>, and <b>secure</b> way.
      </p>
    </div>
      @if(Auth::check())
                ...
                @else
                    <a id="splash-register-link" class="register-link btn btn-success btn-lg" href="index.html">
...
<form  action="index.html" class="search-form" method="post" > <input type='hidden' name='csrfmiddlewaretoken' value='CEJ1j68HxFqy6Zvo7ULIdYsR1Dra2U7VqFCaisBWjB45QDE5w0pgoZnUMVuYMhpc' /> <div  
...
<a href="index.html">
        ...
        <tr class="clickable">
            <td class="column-user">
                <a href="index.html">madrid0118 (30+; 100%)</a>
    <span title="Typically replies within minutes" class="online-status online-status-online">
        <i class="fa fa-circle"></i>
    </span>
            </td>
...
Buyer
        ...
        <tr class="clickable">
            <td class="column-user">
                <a href="index.html">Henrytineo (500+; 97%)</a>
...
<a href="index.html">
                    ...
                    BOA-WF-BB&amp;T-CHASE-BBVA-REGIONS-TD-PNC-ETC
                    <i class="fa fa-thumbs-o-up safe-badge"></i>
                </td>
            <td class="column-price">
                9,518.25 USD
        ...
        <tr class="clickable">
            <td class="column-user">
                <a href="index.html">zephyhills0821 (500+; 100%)</a>
    <span title="Typically replies within 30 minutes" class="online-status online-status-recent">
        <i class="fa fa-circle"></i>
    </span>
            </td>
...
<a href="index.html">
                    ...
                    TD-BOA-WF-BB&amp;T-Chase-BBVA-Regions-Suntrust
                    <i class="fa fa-thumbs-o-up safe-badge"></i>
                </td>
            <td class="column-price">
                9,462.25 USD
        ...
        <tr class="clickable">
            <td class="column-user">
                <a href="index.html">Jinxlo (1000+; 99%)</a>
    <span title="Typically replies within minutes" class="online-status online-status-online">
        <i class="fa fa-circle"></i>
    </span>
            </td>
...
<a href="index.html">
        ...
        <tr class="clickable">
            <td class="column-user">
                <a href="index.html">giancatalano (3000+; 100%)</a>
    <span title="Typically replies within minutes" class="online-status online-status-online">
        <i class="fa fa-circle"></i>
    </span>
            </td>
...
<a href="index.html">
                    ...
                    *** Zelle *** Security and Trust - Activo
                    <i class="fa fa-thumbs-o-up safe-badge"></i>
                </td>
            <td class="column-price">
                9,319.60 USD
        ...
        <tr class="clickable">
            <td class="column-user">
                <a href="index.html">Honeycuttt (100+; 99%)</a>
    <span title="Typical response time not known yet" class="online-status online-status-offline">
        <i class="fa fa-circle"></i>
    </span>
            </td>
