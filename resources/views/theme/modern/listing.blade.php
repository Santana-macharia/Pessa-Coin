                    ...
                    <div class="modern-top-hom-cat-section">
                        ...
                        <div class="modern-home-search-bar-wrap">
                            <div class="search-wrapper">
                                ...
                                <form class="form-inline" action="{{ route('market') }}" method="get">
             ...
             <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <?php
                        $allAdTab = route('market').str_replace('/', '', str_replace(route('market'), '', request()->fullUrlWithQuery(['adType'=>'all'])));
                        $personalAdTab = route('market').str_replace('/', '', str_replace(route('market'), '', request()->fullUrlWithQuery(['adType'=>'personal'])));
                        $businessAdTab = route('market').str_replace('/', '', str_replace(route('market'), '', request()->fullUrlWithQuery(['adType'=>'business'])));
                                                ...
                                                @foreach($premium_ads as $ad)
                                                    ...
                                                    <tr class="ad-{{ $ad->price_plan }}">
                                                        ...
                                                        <td>
                                                            ...
                                                            <p class="text-muted">
                                                                @if($ad->city)
                                                                    <i class="fa fa-map-marker"></i> <a class="location text-muted" href="{{ route('market', ['city'=>$ad->city->id]) }}"> {{ $ad->city->city_name }} </a>,
                                                                @endif
                        ...
                        <div class="ad-box-list-view">
                           ...
                           @foreach($ads as $ad)
                                <tr>
                                    ...
                                    <td> <p class="listViewItemFooter"><span>{{ $ad->payment_method }} </span></p></td>
                                    <td><h5>USD {{ $ad->price*get_option('premium_ads_price') }} </h5></td>
                                    <td>{{ $ad->user->get_address()}}</td>
                                    <td> <a href="{{ route('single_ad', $ad->slug) }}" class="btn btn-info">Buy </a></td>
                                </tr>
                            @endforeach
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <a href="{{route('sell')}}" class="btn btn-info btn-lg">@lang('app.post_an_ad')</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#shortBySelect').change(function () {
                ...
                location.href = '{{ route('market') }}?' + form_input + '&shortBy=' + $(this).val();
            });
        });
