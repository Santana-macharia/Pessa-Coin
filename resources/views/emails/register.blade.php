...
<h1 style="text-align: center; padding: 20px 10px; background-color: #23527c; color: #FFF;">
	{{ get_text_tpl(get_option('footer_company_name')) }} Account creation
</h1>
<p>Congratulations!</p>
<p>Thank you for registering on {{ get_text_tpl(get_option('footer_company_name')) }}. You have registered with the following</p>
<br>
