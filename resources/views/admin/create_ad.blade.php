                ...
                <div class="row">
                    <div class="col-md-10 col-xs-12">
                        ...
                        <div class="form-group {{ $errors->has('purpose')? 'has-error':'' }}">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control select2NoSearch" name="purpose" id="purpose">
                                    <option value="sell" {{ old('purpose') == 'sale' ? 'selected':'' }}>@lang('app.sell_bitcoins_online')</option>
                                    <option value="buy" {{ old('purpose') == 'rent' ? 'selected':'' }}>@lang('app.buy_bitcoins_online')</option>
                                </select>
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">@lang('app.price_equation'):</label>
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <span class="input-group-addon">{{ get_option('currency_sign') }}</span>
                                    <input type="text" class="form-control input-sm" placeholder="@lang('app.price_equation')" value="{{ old('price_per_unit') }}" name="price_per_unit" id="price_per_unit">
                                </div>
                        ...
                        <div class="form-group {{ $errors->has('floor')? 'has-error':'' }}">
                            <label for="floor" class="col-sm-4 control-label">@lang('app.bank_name')</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->has('beds')? 'has-error':'' }}">
                            <label for="beds" class="col-sm-4 control-label">@lang('app.margin')</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="beds" value="{{ old('beds') }}" name="beds" placeholder="@lang('app.margin')">
