...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        init : function(controller, condition, value) {
            ...
            if(!condition) {
                // Rule by a function
                this.condition = controller;
                this.controller = null;
                this.value = null;
            } else {
                // Rule by a conditions
         ...
         * Create a sub-rule.
         *
         * You can create controller -> condition –> value rules
         * or just a give a custom callback.
         *
         * Example by passing controller, condition and value:
         *
         ...
         *
         * Example 2 (complex rule, with two dependencies) by passing a function:
         *
         *      var rule = ruleset.createRule(function() { return $("input[name=a]").val() == '1' && $("input[name=b]").val() == '2' });
         *
         *
